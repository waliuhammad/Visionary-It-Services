                  ...
                  <tr key={o.id} className="border-b border-neutral-50 hover:bg-neutral-50/50">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        {o.paymentMethod === 'card' ? <CreditCard className="w-4 h-4 text-neutral-400" /> : <Banknote className="w-4 h-4 text-brand-500" />}
                        <span className="uppercase text-xs font-bold tracking-wider text-neutral-600">{o.paymentMethod || 'COD'}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <span className={`px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider ${
                        o.paymentStatus === 'paid' ? 'bg-brand-100 text-brand-700' : 'bg-brand-100 text-brand-700'
                      }`}>
