 ...
 *  - iconBg: Tailwind bg class for the icon chip (e.g. "bg-blue-100")
 *  - iconColor: Tailwind text class for the icon (e.g. "text-blue-500")
 ...
 */
export default function StatCard({ icon: Icon, iconBg, iconColor, label, value, badge, badgeColor = 'bg-emerald-100 text-emerald-600' }) {
  return (
